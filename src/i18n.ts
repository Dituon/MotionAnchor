  ...
  en: {
    translation: {
      ...
      diagnostics: {
        ...
        loadingMessage: "Loading input status...",
        metric: "Metric",
        mice: "Mice",
        never: "Never",
        polls: "Polls",
        inputDescription: "Tune overlay diagnostics and global input delivery.",
        inputStatus: {
          error: "Error",
          listening: "Listening",
          stopped: "Stopped",
      ...
      inputSettings: {
        deadzone: "Deadzone",
        description: "Map physical devices into global vector inputs.",
        invertX: "Invert X",
        invertY: "Invert Y",
        reset: "Reset input profile",
        scale: "Scale",
        title: "Input profile",
      },
      pluginEnvironment: {
  ...
  zh: {
    translation: {
      ...
      diagnostics: {
        ...
        never: "从未",
        polls: "轮询",
        inputDescription: "来自全局输入运行时的实时状态。",
        inputStatus: {
          error: "错误",
          listening: "监听中",
          stopped: "已停止",
